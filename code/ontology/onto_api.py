...
class OntologyAPI:
    ...
    def setclassenergycontrolling(self, id, name, type, description, systemtype, counter, task):
        self.onto.Energy_Controlling(name, Name = [id], Type = [type], Description = [description], System_Type = [systemtype], Counter = [counter], Task = [task])
    ...
    def setclassenergyconsumingappliances(self, id, name, type, description, Power_Consuming_Maximum, Power_Consuming_Average, Power_Consuming_Current, Consuming_Begin, Consuming_End, Active):
        self.onto.Energy_Consuming_Appliances(name, Name = [id], Type = [type], Description = [description], Power_Consuming_Maximum = [Power_Consuming_Maximum], Power_Consuming_Average = [Power_Consuming_Average], Power_Consuming_Current = [Power_Consuming_Current], Consuming_Begin = [Consuming_Begin], Consuming_End = [Consuming_End], Active = [Active])
        self.onto.save('Ontology_Beta.owl')
